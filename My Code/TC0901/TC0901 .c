...
//  File........: TC0901.c
//  Authors.....: Tom Tripp
//  Description.: This is a test case that tests the AutoCTS
//
//  Conditions:
//    IFACE:  SPI or I2C
//    BAUD:    bps
...
unsigned int err;
int i = 0;
unsigned char tx_data[] = "Maxim - The Quick Brown Fox Came Down With The Pox.\n";
...
//before interrupts enabled

    // Enable AutoRTS and AutiCTS
    wreg( EFR, EFR_AUTO_CTS );
