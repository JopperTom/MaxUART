...
#define RBR               0x0000    /* Receive buffer REGISTER      */
#define THR               0x0000    /* Transmit holding REGISTER    */
#define IER               0x0001    /* Interrupt Enable REGISTER    */
...
#define IIR               0x0002    /* Interrupt ID REGISTER        */
...
#define FCR               0x0002    /* FIFO Control REGISTER        */
...
#define LCR               0x0003    /* Line control REGISTER        */
...
#define MSR               0x0006    /* Modem Status REGISTER        */
#define MSR_DELTA_CTS     0x01      /* Bit that shows Delta in CTS  */
#define MSR_CTS           0x10      /* Bit that shows State of CTS  */
#define DLL               0x0000    /* Divisor latch LSB            */
#define DLM               0x0001    /* Divisor latch MSB            */
#define SCR               0x0007    /* Scratch REGISTER             */
// Below here are not 16550 registers
#define xDLL              0x0008    /* xtended Divisor Latch LSB Table 13.4.2.2   */
#define xDLM              0x0009    /* xtended Divisor Latch MSB Table 13.4.2.2   */
#define xNO_NAME          0x000A    /* Read LSR + RBR registers  Table 13.4.2.2   */
#define HCR               0x001F    /* Hardware Control REGISTER Table 13.4.2.2   */
#define TST               0x002F    /* Test REGISTER             Table 13.4.2.2   */
#define RCR               0x000D    /* Revision REGISTER            */
#define EFR               0x000E    /* Extended Function REGISTER   */
...
#define HCR               0x001F    /* Hardware Control REGISTER    */
...
#define TST               0x002F    /* Test REGISTER                */
