...
//  File........: TC0131.c
//  Authors.....: Tom Tripp
//  Description.: Test 6 bit characters
//
//  Conditions:
//    IFACE:  SPI
//    BAUD:   38,400 bps
...
//    char tx;
// We need to make sure that the data we send is 6bits or less.
//  char string[] = "!!!###$$$%%%&&&''((()))***+++,,,---???<<<>>>";
    int i;
...
////////////////////////////////////////////////////
    ...
    port_set( port, 38400L, 'N', 6, 1, YES_FIFO, 0x00 );
///// Your Code Here //////////////////////////////

// We need to keep data to 6bits or less 0 to 63 (0h-3Fh)
  for( i = 0 ; i <= 63 ; i++)
  {
