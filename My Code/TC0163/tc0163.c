...
//  File........: TC0163.c
//  Authors.....: Tom Tripp
//  Description.: Test RX FIFOs trigger 8Byte - drop below level
//
//  Conditions:
//    IFACE:  SPI 
//    BAUD:   57600 bps
...
////////////////////////////////////////////////////
    ...
    port_set( port, 57600L, 'N', 8, 1, YES_FIFO, FCR_RX_TRIG_8B );
...
/////// Your Code Here //////////////////////////////
    ...
    // results should be as FIFO goes from 8 characters
    // to seven characters.
